...
data class EtoroPosition(val InstrumentID: String, val IsBuy: Boolean, val Leverage: Int,
                         ...
                         val IsDiscounted: Boolean, val Amount: Int, val ViewRateContext: ViewContext)
...
class EtoroHttpClient {
    ...
    fun openPosition(position: Position): Position {
        ...
        val positionRequestBody = EtoroPosition(position.id, type, position.leverage, 0.01, 0, false, 50,
                0.01, false, false, position.amount, ViewContext(price))
