...
class EtoroLightStreamerClient {
    ...
    @Autowired
    lateinit var credentialsService: EtoroMetadataService
    ...
    @PostConstruct
    fun init() {
        positionListener = EtoroPositionListener()
        positionListener.transactionPool = TransactionPool()
        priceListener = EtoroPriceListener()
        priceListener.watchlist = watchlist
